...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        projectsRecyclerViewAdapter = new ProjectsRecyclerViewAdapter(CurrentSessionHolder.getInstance().getRootProjectsOfUser(), getContext());
        ...
        foldersRecyclerViewAdapter = new FoldersRecyclerViewAdapter(CurrentSessionHolder.getInstance().getFoldersOfUser(), getContext());
